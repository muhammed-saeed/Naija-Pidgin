import pandas as pd
import numpy as np
train_df_path = "/content/drive/MyDrive/Naija Project/Sentiment Analysis/shamusdeen data/pcm_train.csv"
dev_df_path = "/content/drive/MyDrive/Naija Project/Sentiment Analysis/shamusdeen data/pcm_dev.csv"
test_df_path = "/content/drive/MyDrive/Naija Project/Sentiment Analysis/shamusdeen data/pcm_test.csv"

train_bpe_text_path = "/content/pcm_senti/train.input0"
train_bpe_label_path = "/content/pcm_senti/train.label"

dev_bpe_text_path = "/content/pcm_senti/dev.input0"
dev_bpe_label_path = "/content/pcm_senti/dev.label"
