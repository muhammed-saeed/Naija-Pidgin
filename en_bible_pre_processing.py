...
for page in range(len(en_chapters_start)-1):
    ...
    one_line_text = None
    print(
        f"statring page is {en_chapters_start[page]} and the end page is {en_chapters_start[page+1]}")

    for i in range(en_chapters_start[page]-1, en_chapters_start[page+1]-1):
        # for i in range(4, 49):
    ...
    chatper_text = FF
    chapter_path = "/home/muhammed/Desktop/pcm_en_parrellel/chapters/en_chapter_" + \
        str(page+1)+"_.txt"
