...
train_df_path = "C:\Users\lst\Desktop\Naija-Pidgin\Sentiment Analysis PCM\naijasenti_dataset_v1.0\naijasenti_dataset_v1.0\pidgin\pcm_train.csv"
test_df_path = "C:\Users\lst\Desktop\Naija-Pidgin\Sentiment Analysis PCM\naijasenti_dataset_v1.0\naijasenti_dataset_v1.0\pidgin\pcm_test.csv"
...
model = model_class.from_pretrained(model_path, config=model_path)
print('Model=\n',model,'\n')

tokenizer = tokenizer_class.from_pretrained(tokenizer_path, do_lower_case=False)
print('Tokenizer=',tokenizer,'\n')
