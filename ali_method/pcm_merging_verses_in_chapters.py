...
files = os.listdir(
    '/home/muhammed/Desktop/pcm_en_parrellel/BLOCKS_SPANS/pcm_bible/pcm')
# print(files)
# for file in files:
#   # do something
...
for chapter in to_be_ordered_list_2:
    general_path = '/home/muhammed/Desktop/pcm_en_parrellel/BLOCKS_SPANS/pcm_bible/pcm'
    for i in chapter:
        verse_path = general_path + "/"+str(i)
        chapter_path = "/home/muhammed/Desktop/pcm_en_parrellel/BLOCKS_SPANS/pcm_bible/chapters/"
        chapter_path_counter = chapter_path + "pcm_" + str(counter) + ".txt"
