...
1. Manually Annotated Twitter Sentiment Dataset (We only provide the training and development sets in this release (except pidgin). The test set will be used for a Zindi competition that we will lunch soon). For Pidgin, we release the first version of the dataset, we will release the full version soon. 
