...
# fixed according to http://hg.python.org/cpython/rev/9eac48fbe21d
# because of ValueError I/O, missing Connection:closed; Issue12576
# changes marked with  #C12576 
print('uses fixed version of request.py')
...
class AbstractHTTPHandler(BaseHandler):
    ...
    def do_open(self, http_class, req, **http_conn_args):
        ...
        try:
            ...
            #C12576 r = h.getresponse()  # an HTTPResponse instance
        #C12576 except socket.error as err:
